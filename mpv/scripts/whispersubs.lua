...
local WHISPER_CMD = "whisper.cpp -m /var/home/luser/git/whisper.cpp/models/ggml-base.en.bin --threads 6 --language en"
...
local function whispSubs(media_path, file_length, current_pos, is_stream)
    ...
    if is_paused then
        mp.add_timeout(1.0, function() whispSubs(media_path, file_length, current_pos, is_stream) end)
